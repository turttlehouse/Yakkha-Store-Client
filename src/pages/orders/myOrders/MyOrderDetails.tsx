    ...
    <>
      ...
      <div className="px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        <div className="flex justify-start item-start flex-col">
          <h1 className="text-1xl dark:text-black lg:text-2xl font-semibold leading-7 lg:leading-9 text-gray-600">
            Order Details
          </h1>
        ...
        <div className="mt-1 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
          <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
            ...
            <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-1 md:space-y-0 md:space-x-6 xl:space-x-8">
              <div className="flex flex-col px-4 py-1 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-gray-800 space-y-2">
